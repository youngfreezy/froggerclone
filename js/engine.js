...
var Engine = (function(global) {
     ...
     * allEnemies and player are now variables in Engine.
     */
     ...
     * begins the game and when the user wins or loses.
     */
     ...
     * to see if it is within a small distance from the player. If it is it
     * calls the player's restart method.
     */
    ...
    /* This function resets the game, initializing the enemies and the player.
     * It's called by the init() method and when the user wins or loses.
     */
    function reset() {
        initializeEnemies();
        player = new Player();
